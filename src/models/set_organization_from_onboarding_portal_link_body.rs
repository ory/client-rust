...
pub struct SetOrganizationFromOnboardingPortalLinkBody {
...
impl SetOrganizationFromOnboardingPortalLinkBody {
    pub fn new(kratos_selfservice_methods_oidc_config_providers: Vec<models::NormalizedProjectRevisionThirdPartyProvider>, kratos_selfservice_methods_saml_config_providers: Vec<models::NormalizedProjectRevisionSamlProvider>, revision_id: String) -> SetOrganizationFromOnboardingPortalLinkBody {
