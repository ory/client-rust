...
pub struct NormalizedProjectRevisionThirdPartyProvider {
    ...
    #[serde(rename = "aal2_acr_values", skip_serializing_if = "Option::is_none")]
    pub aal2_acr_values: Option<Vec<String>>,
    ...
    #[serde(rename = "aal2_amr_values", skip_serializing_if = "Option::is_none")]
    pub aal2_amr_values: Option<Vec<String>>,
    ...
    #[serde(rename = "account_linking_mode", skip_serializing_if = "Option::is_none")]
    pub account_linking_mode: Option<AccountLinkingModeEnum>,
    ...
    #[serde(rename = "update_identity_on_login", skip_serializing_if = "Option::is_none")]
    pub update_identity_on_login: Option<UpdateIdentityOnLoginEnum>,
...
impl NormalizedProjectRevisionThirdPartyProvider {
    pub fn new() -> NormalizedProjectRevisionThirdPartyProvider {
        NormalizedProjectRevisionThirdPartyProvider {
            aal2_acr_values: None,
            aal2_amr_values: None,
            account_linking_mode: None,
...
pub enum AccountLinkingModeEnum {
    #[serde(rename = "automatic")]
    Automatic,
    #[serde(rename = "confirm_with_existing_credential")]
    ConfirmWithExistingCredential,
}

impl Default for AccountLinkingModeEnum {
    fn default() -> AccountLinkingModeEnum {
        Self::Automatic
    }
}
/// 
...
/// UpdateIdentityOnLogin controls whether the identity is updated from OIDC claims on each login.  Possible values are \"never\" (default) and \"automatic\". never UpdateIdentityOnLoginNever  UpdateIdentityOnLoginNever disables identity updates on login (default). automatic UpdateIdentityOnLoginAutomatic  UpdateIdentityOnLoginAutomatic re-runs the Jsonnet claims mapper on every  OIDC login and updates the identity's traits and metadata automatically.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum UpdateIdentityOnLoginEnum {
    #[serde(rename = "never")]
    Never,
    #[serde(rename = "automatic")]
    Automatic,
...
impl Default for UpdateIdentityOnLoginEnum {
    fn default() -> UpdateIdentityOnLoginEnum {
        Self::Never
    }
}
