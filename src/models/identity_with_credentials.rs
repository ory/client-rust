...
pub struct IdentityWithCredentials {
    ...
    pub lookup_secret: Option<Box<models::AdminIdentityImportCredentialsLookupSecret>>,
    #[serde(rename = "oidc", skip_serializing_if = "Option::is_none")]
    pub oidc: Option<Box<models::IdentityWithCredentialsOidc>>,
    #[serde(rename = "passkey", skip_serializing_if = "Option::is_none")]
    pub passkey: Option<Box<models::IdentityWithCredentialsPasskey>>,
    ...
    pub totp: Option<Box<models::IdentityWithCredentialsTotp>>,
    #[serde(rename = "webauthn", skip_serializing_if = "Option::is_none")]
    pub webauthn: Option<Box<models::IdentityWithCredentialsWebAuthn>>,
}
