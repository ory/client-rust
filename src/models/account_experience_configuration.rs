...
pub struct AccountExperienceConfiguration {
    ...
    #[serde(rename = "locale_behavior")]
    pub locale_behavior: LocaleBehaviorEnum,
    ...
    pub translations: Vec<models::RevisionAccountExperienceCustomTranslation>,
...
pub enum LocaleBehaviorEnum {
    #[serde(rename = "force_default")]
    ForceDefault,
    #[serde(rename = "respect_accept_language")]
