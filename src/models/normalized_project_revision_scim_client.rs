...
pub struct NormalizedProjectRevisionScimClient {
    ...
    #[serde(rename = "proxy_scim_server_url", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub proxy_scim_server_url: Option<Option<String>>,
