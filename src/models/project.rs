...
impl Project {
    pub fn new(environment: EnvironmentEnum, home_region: HomeRegionEnum, id: String, name: String, organizations: Vec<models::BasicOrganization>, revision_id: String, services: models::ProjectServices, slug: String, state: StateEnum) -> Project {
        Project {
            cors_admin: None,
            cors_public: None,
            environment,
