...
pub enum AccessPolicyEnum {
    #[serde(rename = "CHECK_ORGANIZATION_AND_WORKSPACE_MEMBERSHIP")]
    CheckOrganizationAndWorkspaceMembership,
    #[serde(rename = "CHECK_ACCESS_PERMISSION")]
    CheckAccessPermission,
}

impl Default for AccessPolicyEnum {
    fn default() -> AccessPolicyEnum {
        Self::CheckOrganizationAndWorkspaceMembership
    }
}
