...
pub enum TokenAlgorithm {
    #[serde(rename = "TOKEN_ALGORITHM_UNSPECIFIED")]
    TokenAlgorithmUnspecified,
    #[serde(rename = "TOKEN_ALGORITHM_JWT")]
    TokenAlgorithmJwt,
    #[serde(rename = "TOKEN_ALGORITHM_MACAROON")]
...
impl std::fmt::Display for TokenAlgorithm {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::TokenAlgorithmUnspecified => write!(f, "TOKEN_ALGORITHM_UNSPECIFIED"),
            Self::TokenAlgorithmJwt => write!(f, "TOKEN_ALGORITHM_JWT"),
            Self::TokenAlgorithmMacaroon => write!(f, "TOKEN_ALGORITHM_MACAROON"),
        }
    }
}
...
impl Default for TokenAlgorithm {
    fn default() -> TokenAlgorithm {
        Self::TokenAlgorithmUnspecified
    }
}
