...
pub struct NormalizedProjectRevisionSamlProvider {
    #[serde(rename = "audience_override_base_url", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub audience_override_base_url: Option<Option<String>>,
    ...
    #[serde(rename = "proxy_acs_url", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub proxy_acs_url: Option<Option<String>>,
    #[serde(rename = "proxy_saml_audience_override", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub proxy_saml_audience_override: Option<Option<String>>,
    ...
    pub valid_to: Option<Vec<String>>,
}
...
impl NormalizedProjectRevisionSamlProvider {
    pub fn new() -> NormalizedProjectRevisionSamlProvider {
        NormalizedProjectRevisionSamlProvider {
            audience_override_base_url: None,
            created_at: None,
            id: None,
            label: None,
            mapper_url: None,
