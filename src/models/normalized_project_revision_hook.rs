...
pub struct NormalizedProjectRevisionHook {
    ...
    #[serde(rename = "notify_previous_addresses_config_recipients", skip_serializing_if = "Option::is_none")]
    pub notify_previous_addresses_config_recipients: Option<String>,
...
impl NormalizedProjectRevisionHook {
    pub fn new(config_key: String, hook: String) -> NormalizedProjectRevisionHook {
        NormalizedProjectRevisionHook {
            ...
            hook,
            id: None,
            notify_previous_addresses_config_recipients: None,
