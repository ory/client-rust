...
pub async fn create_browser_registration_flow(configuration: &configuration::Configuration, return_to: Option<&str>, login_challenge: Option<&str>, after_verification_return_to: Option<&str>) -> Result<crate::models::RegistrationFlow, Error<CreateBrowserRegistrationFlowError>> {
