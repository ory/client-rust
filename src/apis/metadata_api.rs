...
pub async fn get_version(configuration: &configuration::Configuration, ) -> Result<crate::models::GetVersion200Response, Error<GetVersionError>> {
...
pub async fn is_alive(configuration: &configuration::Configuration, ) -> Result<crate::models::HealthStatus, Error<IsAliveError>> {
...
pub async fn is_ready(configuration: &configuration::Configuration, ) -> Result<crate::models::IsReady200Response, Error<IsReadyError>> {
