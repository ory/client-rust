...
pub async fn create_event_stream(configuration: &configuration::Configuration, project_id: &str, create_event_stream_body: models::CreateEventStreamBody) -> Result<models::EventStream, Error<CreateEventStreamError>> {
    ...
    let p_body_create_event_stream_body = create_event_stream_body;

    let uri_str = format!("{}/projects/{project_id}/eventstreams", configuration.base_path, project_id=crate::apis::urlencode(p_path_project_id));
    ...
    req_builder = req_builder.json(&p_body_create_event_stream_body);
...
pub async fn delete_event_stream(configuration: &configuration::Configuration, project_id: &str, event_stream_id: &str) -> Result<(), Error<DeleteEventStreamError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_path_event_stream_id = event_stream_id;

    let uri_str = format!("{}/projects/{project_id}/eventstreams/{event_stream_id}", configuration.base_path, project_id=crate::apis::urlencode(p_path_project_id), event_stream_id=crate::apis::urlencode(p_path_event_stream_id));
...
pub async fn set_event_stream(configuration: &configuration::Configuration, project_id: &str, event_stream_id: &str, set_event_stream_body: Option<models::SetEventStreamBody>) -> Result<models::EventStream, Error<SetEventStreamError>> {
    ...
    let p_path_project_id = project_id;
    let p_path_event_stream_id = event_stream_id;
    let p_body_set_event_stream_body = set_event_stream_body;
    ...
    req_builder = req_builder.json(&p_body_set_event_stream_body);
