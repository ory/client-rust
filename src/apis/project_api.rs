...
pub async fn create_project_api_key(configuration: &configuration::Configuration, project: &str, create_project_api_key_body: Option<models::CreateProjectApiKeyBody>) -> Result<models::ProjectApiKey, Error<CreateProjectApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project = project;
    let p_body_create_project_api_key_body = create_project_api_key_body;
    ...
    req_builder = req_builder.json(&p_body_create_project_api_key_body);
